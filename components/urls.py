...
urlpatterns = [
    ...
    path('placeholders',views.PlaceholderView.as_view(),name='uielements-placeholders'),
    ...
    path('toasts',views.ToastView.as_view(),name='uielements-toasts'),
    ...
    #Icons
    path('unicons',views.UnIconsView.as_view(),name='icons-unicons'),
